   ...
   stages {
        ...
        stage('Deploy') {
            ...
            steps {
                ...
                sh 'sudo cp -rf /home/ubuntu/workspace/paramerized_pipeline1/target/grants.war /var/lib/tomcat8/webapps/'
                sh 'sudo cp -rf /home/ubuntu/workspace/paramerized_pipeline1/tomcat-users.xml /etc/tomcat8/'
